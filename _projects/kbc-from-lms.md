...
{% cite kalo2020knowlybert %}.
Earlier work on [Prompt Tuning or Fine-Tuning](/publications/#fichtel2021prompt)
(AKBC 2021) {% cite fichtel2021prompt %} and
[Prompting as Probing](/publications/#alivanistos2022prompting)
(LM-KBC 2022) {% cite alivanistos2022prompting %} laid the groundwork for
treating LMs as queryable KBs. The
