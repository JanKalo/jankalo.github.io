...
[Trevor Pearce](https://nl.linkedin.com/in/trevor-pearce-5b9b0399)
(knowledge graph construction from conversational data; UvA), and
[Lucas Lageweg](https://lagewel001.github.io/LOCuST/) (text-to-SQL over
official statistics, with Statistics Netherlands). I have supervised more
...
from language models. I am part of the management team of the COST Action
[KGELL](https://www.cost.eu/actions/CA24121/) (CA24121), active in the COST
Action [GOBLIN](https://goblin-cost.eu/) (CA23147) on large-scale open
multilingual knowledge graphs, and a contributor to the
[ISWS summer school](https://2026.semanticwebschool.org/).
...
- [LOCuST](https://lagewel001.github.io/LOCuST/) — a multilingual benchmark for text-to-SQL over official statistics
- [LM-KBC challenge datasets](https://lm-kbc.github.io/) — knowledge base construction from language models
- [KAMEL](https://github.com/JanKalo/KAMEL) — a probing benchmark with multi-token entities
- [KnowlyBERT](https://github.com/JanKalo/KnowlyBERT) — hybrid query answering over language models and knowledge graphs
- [WILA-PopQA](https://github.com/duo0301/WILA-popQA) — a popularity-matched multilingual factual-recall benchmark

Before Amsterdam, I did my PhD at TU Braunschweig (2021) on representation
heterogeneity in knowledge graphs — the same problem I now call knowledge
translation — followed by a postdoc in the Knowledge Representation and
Reasoning group at VU Amsterdam. A longer bio for talk introductions is
[here](/bio/).
